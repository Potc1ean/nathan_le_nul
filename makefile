...
#    Updated: 2024/07/15 12:51:34 by ichpakov         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CFLAGS = -Werror -Wextra -Wall -fsanitize=address -static-libsan -I/Users/ichpakov/.brew/opt/readline/include
...
${NAME}: ${OBJS}
				...
				@${MAKE} -C ./ms_libft
				@${CC} ${CFLAGS} ${OBJS} ./ms_libft/libft.a -o ${NAME} -lreadline -L/Users/ichpakov/.brew/opt/readline/lib
